...
export interface ClaimTunnelResponse {
  ...
  signatures:
    ...
    | undefined;
  /** Optional processed data if a processor function was provided */
  processedData: ProcessedClaimData | undefined;
}
...
export const ClaimTunnelRequest: MessageFns<ClaimTunnelRequest> = {
  encode(message: ClaimTunnelRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.processor !== undefined) {
      writer.uint32(66).string(message.processor);
    }
    return writer;
  },
...
function createBaseProcessedClaimData(): ProcessedClaimData {
  return { processorProviderHash: "", signature: new Uint8Array(0), outputs: [], values: [] };
}
...
export const ProcessedClaimData: MessageFns<ProcessedClaimData> = {
  encode(message: ProcessedClaimData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.processorProviderHash !== "") {
      writer.uint32(10).string(message.processorProviderHash);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProcessedClaimData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<ProcessedClaimData>): ProcessedClaimData {
    return ProcessedClaimData.fromPartial(base ?? {});
  },
...
function createBaseClaimTunnelResponse(): ClaimTunnelResponse {
  return { request: undefined, claim: undefined, error: undefined, signatures: undefined, processedData: undefined };
}
...
export const ClaimTunnelResponse: MessageFns<ClaimTunnelResponse> = {
  encode(message: ClaimTunnelResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.processedData !== undefined) {
      ProcessedClaimData.encode(message.processedData, writer.uint32(42).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.processedData = ProcessedClaimData.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ClaimTunnelResponse {
    return {
      ...
      processedData: isSet(object.processedData) ? ProcessedClaimData.fromJSON(object.processedData) : undefined,
    };
  },
  ...
  toJSON(message: ClaimTunnelResponse): unknown {
    ...
    if (message.processedData !== undefined) {
      obj.processedData = ProcessedClaimData.toJSON(message.processedData);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<ClaimTunnelResponse>): ClaimTunnelResponse {
    ...
    message.signatures = (object.signatures !== undefined && object.signatures !== null)
      ...
      : undefined;
    message.processedData = (object.processedData !== undefined && object.processedData !== null)
      ? ProcessedClaimData.fromPartial(object.processedData)
      : undefined;
    return message;
  },
};
