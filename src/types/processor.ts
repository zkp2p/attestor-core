...
/**
 * ConditionalOn transform configuration
 */
export interface ConditionalOnTransform {
  type: 'conditionalOn'
  checkField: string // Required field to check condition on
 ...
 */
export type TransformFunction = (value: any, params?: any, context?: Record<string, any>) => any;
...
export type ProcessedClaimData = {
	/** Hash combining the provider hash and processor configuration */
